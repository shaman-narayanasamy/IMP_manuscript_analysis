...
#/mnt/nfs/projects/ecosystem_biology/local_tools/cd-hit-v4.6.1-2012-08-27_OpenMP_MAX_SEQ-5MBP/cd-hit-est -i /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_cat_5.fa -o /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_cat_5-cdhit.fa -c 0.95 -t 120

### Using cd-hit-lap to extend contigs based on 100% identity
#/mnt/nfs/projects/ecosystem_biology/local_tools/cd-hit-auxtools-v0.5-2012-03-07/cd-hit-lap -i /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_cat_5-cdhit.fa -o /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_cat_5-cdhit-olap.fa -m 100
...
ln -s /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_cat_5-cdhit-olap.fa /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_merged_5.fa
