...
/mnt/nfs/projects/ecosystem_biology/local_tools/cd-hit-v4.6.1-2012-08-27_OpenMP_MAX_SEQ-5MBP/cd-hit-est -i /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_cat_6.fa -o /scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/simDat-iterative_MG/MG_contigs_cat_6-cdhit.fa -c 0.95 -t 120
