...
INPUT_DIR="/scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/A02_20151130-idba/Preprocessing" \
  OUT_DIR="/scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/A02-iterative_MG/" \
  OUT_LOG="/scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/A02-iterative_MG/A02_iterative_MG.log" \
  TMP="/scratch/users/snarayanasamy/IMP_MS_data/IMP_analysis/A02-iterative_MG/tmp" \
  snakemake ALL
