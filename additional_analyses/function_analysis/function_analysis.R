...
A02.MG <- "/home/shaman/Work/Data/integrated-omics-pipeline/MS_analysis/datasets/IMP_analysis/A02_20151130-idba/Analysis/MG.gene_depth.avg"
A02.MT <- "/home/shaman/Work/Data/integrated-omics-pipeline/MS_analysis/datasets/IMP_analysis/A02_20151130-idba/Analysis/MT.gene_depth.avg"
A02.wkspc <- "/home/shaman/Work/Data/integrated-omics-pipeline/MS_analysis/datasets/IMP_analysis/A02_20151130-idba/Analysis/results/MGMT_results.Rdat"
...
sink("/home/shaman/Documents/Publications/IMP-manuscript/tables/X310763260_MT_contigs.tex")
print(xtable(dat.MT[,c(1:3)]), floating=F, include.rownames=F)
sink()

dat <- get.MT.genes(A02.MG, A02.MT, A02.wkspc)
dat.MT <- dat[is.na(dat$MG_contig_depth) & dat$contig_len >= 500, c(5,1,2,4,6,8,9)]
sink("/home/shaman/Documents/Publications/IMP-manuscript/tables/A02_MT_contigs.tex")
print(xtable(dat.MT[,c(1:3)]), floating=F, include.rownames=F)
sink()

#dat <- get.MT.genes(D36.MG, D36.MT, D36.wkspc)
#dat.MT <- dat[is.na(dat$MG_contig_depth) & dat$contig_len >= 500, c(5,1,2,4,6,8,9)]
#sink("/home/shaman/Documents/Publications/IMP-manuscript/tables/D36_MT_contigs.tex")
#print(xtable(dat.MT[,c(1:3)]), floating=F, include.rownames=F)
#sink()
